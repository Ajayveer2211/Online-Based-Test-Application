...
import { getStudents, getStudentFullDetails } from '../../services/studentService';
...
const AdminDashboard = () => {
  ...
  // New state for student view functionality
  ...
  // New function for viewing student details
  const handleViewStudent = async (studentId) => {
    try {
      console.log("Fetching details for:", studentId);
          ...
          <div className="d-flex flex-column h-100 p-3">
            ...
            <ul className="nav nav-pills flex-column gap-2 mb-auto">
              ...
              <li className="nav-item">
                ...
                >
                  <i className="fas fa-clipboard-list me-2 white-icons"></i> Exams Schedule
                </button>
              </li>
              <li className="nav-item">
                <button
                ...
                >
                  <i className="fas fa-question-circle me-2 white-icons"></i> Question Banks
                </button>
              </li>
              <li className="nav-item">
                <button
        ...
        <div className={`${sidebarCollapsed ? 'col-md-12' : 'col-md-9 col-lg-10'} p-4`}>
          {activeTab === "dashboard" && (
            <div className="container-fluid py-4">
              ...
              {/* Dashboard content remains exactly the same */}
              {/* ... */}
              <div className="row">
          ...
          {activeTab === "students" && <Students onViewStudent={handleViewStudent} />}
