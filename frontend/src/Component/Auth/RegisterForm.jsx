            ...
            <div className="row justify-content-center">
                <div className="col-lg-8">
                    <div className="card shadow-sm border-0">
                        <div className={`card-header text-white text-center ${formData.role === 'teacher' ? 'bg-teacher' : 'bg-gradient'}`}>
                                            ...
                                            <div className="col-md-6 mb-3">
                                                ...
                                                >
                                                    <option value="">Select University</option>
                                                     ...
                                                     <option value="galgotia">Galgotias University</option>
                                                ...
                                                {formData.university === 'other' && (
                                                 ...
                                                 onChange={handleChange}
                                                 className={`form-control mt-2 ${errors.universityOther ? 'is-invalid' : ''}`}
                                                 />
                                                 )}

                                                 {errors.university && <div className="invalid-feedback">{errors.university}</div>}
                                                 {errors.universityOther && <div className="invalid-feedback">{errors.universityOther}</div>}
                                                {errors.university && <div className="invalid-feedback">{errors.university}</div>}
                                            </div>
                                            <div className="col-md-6 mb-3">
